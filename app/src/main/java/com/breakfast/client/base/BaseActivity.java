...
public abstract class BaseActivity extends AppCompatActivity implements BackHandleInterface {
    ...
    protected void setIntentClass(Class<?> cla, String passDataKey, @Nullable Parcelable passDataValue) {
        Intent intent = new Intent();
        intent.setClass(this, cla);
        Bundle bundle = new Bundle();
        bundle.putParcelable(passDataKey, passDataValue);
        intent.putExtras(bundle);
        startActivity(intent);
    }

    protected void setIntentClass(Class<?> cla, String passDataKey, @Nullable Serializable passDataValue) {
        Intent intent = new Intent();
        intent.setClass(this, cla);
        Bundle bundle = new Bundle();
        bundle.putSerializable(passDataKey, passDataValue);
        intent.putExtras(bundle);
        startActivity(intent);
    }

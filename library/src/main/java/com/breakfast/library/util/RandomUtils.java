 ...
 * default source of
 * randomness</li>
 * <li>{@link #shuffle(Object[], int)} Shuffling algorithm, Randomly permutes the specified
 * array</li>
 * <li>{@link #shuffle(int[])} Shuffling algorithm, Randomly permutes the specified int array using
 * a default source of
 * randomness</li>
 * <li>{@link #shuffle(int[], int)} Shuffling algorithm, Randomly permutes the specified int
 * array</li>
 * </ul>
 * <ul>
 * get random int
 ...
 * <li>{@link #getRandomNumbers(int)} get a fixed-length random string, its a mixture of
 * numbers</li>
